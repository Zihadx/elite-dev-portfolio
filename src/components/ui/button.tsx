...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-xl text-sm font-medium ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default:
          "bg-gradient-to-r from-violet-500/90 to-indigo-600/90 text-white shadow-[0_0_24px_-4px_hsl(var(--glow-primary)/0.55)] hover:brightness-110 hover:shadow-[0_0_36px_-4px_hsl(var(--glow-primary)/0.65)]",
        secondary:
          "border border-white/10 bg-white/5 text-foreground backdrop-blur-md hover:bg-white/10 hover:border-white/15",
        ghost: "hover:bg-white/5 hover:text-foreground",
        outline:
          "border border-white/12 bg-transparent hover:bg-white/[0.04] hover:border-violet-400/30",
